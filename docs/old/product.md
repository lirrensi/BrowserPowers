---
node_type: overview
title: BrowserPowers — Product Overview (old format)
status: deprecated
updated: 2026-06-11
tags: [product, overview, deprecated]
links:
...
> **DEPRECATED**: This document is preserved for history. The current version lives at [docs/overview/product.md](../overview/product.md).
